        ...
        {sleepFacts.map((f, i) => {
          ...
          return (
            <motion.div
              ...
              className="group relative flex h-[370px] w-[320px] flex-shrink-0 snap-start flex-col justify-between overflow-hidden rounded-[36px] border border-[#E5E7EB] p-9 shadow-[0_25px_60px_-25px_rgba(23,33,58,0.22)] sm:w-[400px] transition-all hover:shadow-[0_35px_80px_-20px_rgba(23,33,58,0.32)]"
              style={{
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="font-serif text-5xl font-extrabold text-[#DCEBFF]">0{i + 1}</span>
              </div>
              <div>
                <h3 className="font-serif text-2xl font-bold leading-snug text-[#17213A] sm:text-[1.6rem]">{f.title}</h3>
                <p className="mt-3.5 text-[15.5px] font-medium leading-relaxed text-[#4A5568]">{f.desc}</p>
              </div>
              <button className="flex w-fit items-center gap-2 rounded-full border border-[#E5E7EB] bg-white px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-[#17213A] shadow-sm transition hover:bg-[#EEF6FF] hover:border-[#5B8DEF]/40 group-hover:translate-x-1">
